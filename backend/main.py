...
Real estate listing platform with virtual tours and mortgage calculator
"""
...
app = FastAPI(
    title="PropertyPulse",
    description="Real estate listing platform with virtual tours and mortgage calculator",
    version="1.0.0",
)
...
@app.get("/health")
def health_check():
    return {"status": "healthy", "service": "PropertyPulse"}
